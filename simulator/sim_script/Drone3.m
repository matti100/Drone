classdef Drone3 < handle
    ...
    methods
        ...
        %% Constructor
        function obj = Drone3(params, initialCondition, desideredState, gains, tspan, control, estimation, sampleTime)
        ...
        function obj = motorCMD(obj)
            ...
            if (obj.control == 3) 
                ...
                if (obj.control > 0)
                    % LQR
                    stateDes = [obj.xDes(3); obj.xDes(4:6); obj.xDes(7:12)];
                    state = [obj.x(3); obj.x(4:6); obj.x(7:12)];
                    Kmod = [obj.K(:,3), obj.K(:, 4:6), obj.K(:, 7:12)];
                    obj.u_lin = Kmod * (stateDes - state);
                    obj.u1 = obj.u_lin(1);
                    obj.u2 = obj.u_lin(2);
                    obj.u3 = obj.u_lin(3);
                    obj.u4 = obj.u_lin(4);
